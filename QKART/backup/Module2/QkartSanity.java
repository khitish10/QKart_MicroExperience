...
public class QkartSanity {
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        boolean watch=homePage.changeProductQuantityinCart("Xtend Smart Watch", 2);

        // update table lamp quantity to 0
        boolean light=homePage.changeProductQuantityinCart("Yarine Floor Lamp", 0);

        // update watch quantity again to 1
        watch=homePage.changeProductQuantityinCart("Xtend Smart Watch", 1);
